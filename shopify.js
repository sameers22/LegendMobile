...
const SHOPIFY_STORE_URL = 'https://27a7f7-2.myshopify.com/api/2023-10/graphql.json';
const STOREFRONT_ACCESS_TOKEN = '58c098147cc1c2cb3e339cd586b9eaac';
...
export const createCheckout = async (cartItems) => {
    ...
    const result = await response.json();
    console.log("Shopify Response:", JSON.stringify(result, null, 2)); // ✅ ADD THIS
